...
export function parseEnvironment(env: NodeJS.ProcessEnv): BridgeConfig {
  ...
  const config: BridgeConfig = {
    ...
    allowExternalGroupUserMentions: parseBoolean(env, 'ALLOW_EXTERNAL_GROUP_USER_MENTIONS', true),
    allowGroupBotMentions: parseBoolean(env, 'ALLOW_GROUP_BOT_MENTIONS', true),
