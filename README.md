...
- [🔌 Codex-Feishu Bridge (Codex-飞书网桥)](#-codex-feishu-bridge-codex-飞书网桥)
  ...
  - [🔬 核心技术内幕](#-核心技术内幕)
    - [1. 底层通信通道](#1-底层通信通道)
    - [2. 飞书 CardKit 2.0 实时流式更新](#2-飞书-cardkit-20-实时流式更新)
    - [3. 任务取消与中断机制](#3-任务取消与中断机制)
    - [4. 系统指令与技能 (Skills) 调用机制](#4-系统指令与技能-skills-调用机制)
  - [🛠️ 开发与复刻指引](#️-开发与复刻指引)
    - [第一步：开启本地通讯代理](#第一步开启本地通讯代理)
    - [第二步：注册飞书事件监听与 WebSocket 长连接](#第二步注册飞书事件监听与-websocket-长连接)
    - [第三步：发送状态卡片与启动 Turn 执行](#第三步发送状态卡片与启动-turn-执行)
